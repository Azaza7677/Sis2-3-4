...
public class StudentSalary {
    public static void main(String[] args) {
        String inputFile = "studentsTask4.xlsx"; // Входной файл
        ...
        // Обработка и запись данных (как в предыдущем коде)
        processAndWriteData(students, outputFile);
    }

    // Универсальный метод для получения значения ячейки
    ...
    // Метод для обработки и записи данных
    private static void processAndWriteData(List<Map<String, Object>> students, String outputFile) {
        // Обработка данных и запись результатов (как в предыдущем коде)
